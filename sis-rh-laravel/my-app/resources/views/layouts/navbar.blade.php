        ...
        <div class="container-fluid mt-2">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-2">
                    <li class="nav-item">
                        <a class="nav-link active text-light" aria-current="page" href="../components/home.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="listar-solicitacao.php"></i>Listar</a>
                    </li>
                </ul>
            </div>
        </div>
