    ...
    <main>
        <div class="container w-50">
            ...
            <div class="class shadow mt-5">
                <div class="card-header h3 p-3 bg-primary text-white rounded-2">Adicionar veículo</div>
                <div class="card-body mt-2 p-4">
                    <form method="POST" id="formCarro" action="crud.php">
                        ...
                        <button class="btn w-20 justify-content-center text-white btn bg-primary" id="create_carro" name="create_carro">Enviar</button>
                    </form>
                </div>
            </div>
        </div>
